...
def open_input():
    try:
        ...
        logging.warning(f"Error opening input file {e}")
...
def translate_text(**kwargs):
    ...
    except boto3.exceptions.TranslateException as e:
        logging.warning(f"Translate exception occurred {e}")
...
def translate_loop():
    try:
        ...
        logging.warning(f"No validation found: {e}")
...
def input_validation(item):
    try:
        ...
        logging.warning(f"Failed to load source language: {e}")
